...
//					Toast.LENGTH_LONG).show();
	...
	public void onSensorChanged(SensorEvent event) {
		...
		intent1.putExtra("x", Double.valueOf(accBufferX[0]).toString());
		intent1.putExtra("y", Double.valueOf(accBufferY[0]).toString());
		intent1.putExtra("z", Double.valueOf(accBufferZ[0]).toString());
